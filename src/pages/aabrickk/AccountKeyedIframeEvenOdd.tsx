// AccountKeyedIframeEvenOdd.tsx
import { useEffect, useRef, useState, useCallback } from 'react';
import { observer } from 'mobx-react-lite';
import IframeEvenOdd from '../abbrick/IframeEvenOdd';
import { api_base } from '@/external/bot-skeleton';

/**
 * Remounts IframeEvenOdd whenever the active account (loginid) changes.
...
const AccountKeyedIframeEvenOdd = observer(() => {
  ...
  return <IframeEvenOdd key={componentKey} />;
});
