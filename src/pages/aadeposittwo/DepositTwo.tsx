...
const DepositTwo: React.FC = () => {
  ...
  const stopCopytrading = (traderToken: string) => {
    console.log(`🛑 Sending copy_stop for trader ${traderToken}`);
      ...
      <div className="copier-dashboard">
        ...
        <div className="trader-management">
          ...
          <div style={{ marginBottom: '12px' }}>
            <a
              href="https://site.denaratool.com/#CopyTrading"
              target="_blank"
            ...
            >
              <button
                style={{
                  ...
                  borderRadius: '6px',
                  cursor: 'pointer',
                  backgroundColor: '#1a73e8', // Google blue-ish
                  color: '#fff',
                  border: 'none',
                  fontWeight: '600',
                  fontSize: '14px',
              ...
              >
                No active copied traders found.
              </button>
          ...
          <div className="traders-list">
            {traders.length === 0 && !isLoading && (
              <p>Permisions allowed at site.denaratool.com.</p>
            )}
            {traders.map((t, i) => (
              <div key={t.token} className="trader-card">
                ...
                <button
                  onClick={() => stopCopytrading(t.token)}
                  disabled={!t.isCopying}
                >
                  Stop Copytrading
                </button>
              </div>
