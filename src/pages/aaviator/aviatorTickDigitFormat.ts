/**
 * Pip decimals for Aviator chart price scale / crosshair (`aviator*` prefix).
 */
import { api_base } from '@/external/bot-skeleton';

function aviatorFallbackDigitDecimals(market: string): number {
...
export function aviatorResolveDigitTickDecimals(market: string): number {
  ...
  return aviatorFallbackDigitDecimals(market);
}
